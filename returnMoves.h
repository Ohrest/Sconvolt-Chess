...
void returnMoves(vector<movement> &moves, int startx, int starty, int bb[9][8], int side)
{
    ...
    if ((inside_board(startx, starty)) == false)
        exit;
    ...
    if (bb[y1][x1] == 1)
    {
        if (bb[y1 - 1][x1] == 0 && inside_board(y1 - 1, x1))
        {
            adding.toy = x1;
            adding.tox = y1 - 1;
            moves.push_back(adding);
        }
        if (bb[y1 - 1][x1 + 1] < 0 && inside_board(y1 - 1, x1 + 1))
        {
            adding.toy = x1 + 1;
            adding.tox = y1 - 1;
            moves.push_back(adding);
        ...
        if (inside_board(y1 - 2, x1))
            if (y1 == 6 && bb[y1 - 2][x1] <= 0 && bb[y1 - 2][x1] == 0 && bb[y1 - 1][x1] == 0)
            {
                adding.toy = x1;
                adding.tox = y1 - 2;
                moves.push_back(adding);
...
*/
    ...
    if (bb[y1][x1] == -1)
    {
        ...
        if (inside_board(y1 + 2, x1))
            if (y1 == 1 && bb[y1 + 2][x1] >= 0 && bb[y1 + 2][x1] == 0 && bb[y1 + 1][x1] == 0)
            {
                adding.toy = x1;
                adding.tox = y1 + 2;
                moves.push_back(adding);
